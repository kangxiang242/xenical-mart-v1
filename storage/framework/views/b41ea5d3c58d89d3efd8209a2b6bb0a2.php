...
<?php $__env->startSection('content'); ?>
    ...
    <div id="bg-container" class="container-bg"
        data-bg-pc="<?php echo e(asset_upload(app('cache.config')->get('page_check_back_img_pc'))); ?>"
        data-bg-m="<?php echo e(asset_upload(app('cache.config')->get('page_check_back_img'))); ?>">
    </div>
    <h1 class="main-title page-title"><?php echo app('cache.config')->get('page_check_title'); ?></h1>
...
<?php echo $__env->make('web::layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac-2312-r/workspace/wwwroot/纤体-減肥/xenical-mart/xenical-mart-v1/resources/views/web/order/check.blade.php ENDPATH**/ ?>