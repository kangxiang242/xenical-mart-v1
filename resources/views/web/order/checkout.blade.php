                                ...
                                <div class="radio-box">
                                    ...
                                    <div class="form-radio">
                                        ...
                                        <label class="radio-label" for="order-type-1">
                                            ...
                                            <span class="text"><span style="letter-spacing: 0;">7-Eleven</span>便利店</br>取貨付款</span>
                                        </label>
                                    </div>
                    ...
                    <div class="count-column">
                                ...
                                <div class="goods">
                                    ...
                                    <div class="info">
                                        ...
                                        <select class="change" name="goods_ids">
                                            <option data-price="{{ $goods->price }}" data-market-price="{{ $goods->market_price }}" data-img="{{ asset('uploads/'.$goods->img) }}" value="{{ $goods->id }}" data-name="{{ $goods->name }}" data-sub-name="{{ $goods->quantity }}{{ $goods->quantity == 1?"盒標準裝":"盒優惠套裝" }}">更換套裝</option>
                                            @foreach($products as $item)
                                                <option data-price="{{ $item->price }}" data-market-price="{{ $item->market_price }}" data-img="{{ asset('uploads/'.$item->img) }}" value="{{ $item->id }}" data-name="{{ $goods->name }}" data-sub-name="{{ $item->quantity }}{{ $item->quantity == 1?"盒標準裝":"盒優惠套裝" }}">{{ $item->quantity }}{{ $item->quantity == 1?"盒標準裝":"盒優惠套裝" }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="others-sec">
                            ...
                            <div class="sales-sec">
                                ...
                                <div class="sales-item">
                                    <span class="sales-ico"><i class="iconfont">&#xe6b9;</i></span>
                                    <span class="sales-title">14天鑑賞</span>
                                ...
                                <div class="sales-item">
                                    <span class="sales-ico"><i class="iconfont">&#xe6cc;</i></span>
                                    <span class="sales-title">隱密包裝</span>
